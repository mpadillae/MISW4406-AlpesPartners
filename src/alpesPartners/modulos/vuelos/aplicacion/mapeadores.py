...
from alpesPartners.modulos.vuelos.dominio.entidades import Reserva, Aeropuerto
from alpesPartners.modulos.vuelos.dominio.objetos_valor import Itinerario, Odo, Segmento, Leg
