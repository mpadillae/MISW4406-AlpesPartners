from alpesPartners.modulos.vuelos.dominio.objetos_valor import Odo, ParametroBusca, Segmento, Leg, CodigoIATA, Itinerario
from alpesPartners.modulos.vuelos.dominio.entidades import Proveedor,Aeropuerto
